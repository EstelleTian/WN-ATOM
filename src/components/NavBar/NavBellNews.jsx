 ...
 * @LastEditTime: 2021-05-27 10:46:29
  ...
  const add = () => {
    ...
    const msgObj = {
      message: [
        {
          id: 1607,
          timestamp: "Jan 5, 2021 8:11:14 PM",
          generateTime: "20210105201114",
          sendTime: "20210105201119",
          name: "外区流控信息",
          content:
            "过P62进郑州区域20分钟一架 新增 发布单位：ZHHH 2021-01-05 19:00-2021-01-05 23:00",
          data: '{"id":2460918,"sourceId":"547787","source":"ATOM","sourceType":"MIT","sourceStatus":"ADD","content":"过P62进郑州区域20分钟一架","publishUnit":"ZHCC","publishTime":"202101051730","startTime":"202101051900","endTime":"202101052300"}',
          dataCode: "AFAO",
          dataType: "FTMI",
          level: "NOTICE",
          source: "ATOM",
