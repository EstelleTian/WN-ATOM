 ...
 * @LastEditTime: 2021-06-10 17:55:17
    ...
    <div className="total_set">
      <Form form={form}>
        ...
        <div className="set_item">
          ...
          <Form.Item className="set_item_input" rules={rules} name="capacityL1">
            <Input
              maxLength={3}
              className="cap_input"
              ref={capacityL1Ref}
        ...
        <div className="set_item">
          <span className="span_title">超出容量值:</span>
          <Form.Item className="set_item_input" rules={rules} name="capacityL2">
            <Input
              maxLength={3}
              className="cap_input"
              ref={capacityL2Ref}
        ...
        <div className="set_item">
          <span className="span_title">超出容量值:</span>
          <Form.Item className="set_item_input" rules={rules} name="capacityL3">
            <Input
              maxLength={3}
              className="cap_input"
              ref={capacityL3Ref}
