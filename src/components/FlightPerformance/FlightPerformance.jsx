...
const FlightPerformance = (props) => {
    ...
    useEffect(function () {
        ...
        props.implementTacticsData.timeoutId = setInterval(requestImplementTacticsReasonData, 60 * 1000);
        return function () {
            clearInterval(props.flightPerformanceData.timeoutId);
            clearInterval(props.implementTacticsData.timeoutId);
    ...
    const requestImplementTacticsReasonData = useCallback(() => {
        ...
        const end = now;
        const opt = {
            url: ReqUrls.restrictionDataUrl + '?areaName=' + focus + '&starttime=' + start + '&endtime=' + end,
            method: 'GET',
            params: {},
            resFunc: (data) => {
            ...
            <Row className="performance-row" style={{ marginBottom: 10 }}>
                <Col span={24} className="layout-row" >
                    <div className="performance_item module">
                        ...
                        <PerformanceItemHeader style={{ background: "#4b7ba4", color: "#d4d4d4" }} title="计划" />
                    ...
                    <div className="performance_item module">
                        <PerformanceItemHeader style={{ background: "#2e93bb", color: "#d4d4d4" }} title="执行" />
                        <Spin spinning={loading} >
                            <div className="description" >
                                <Tooltip >
                                    <div className="text-wrapper">
                                        <span className="value">{(executeRatio * 100).toFixed(0)}</span>
                    ...
                    <div className="performance_item module">
                        <PerformanceItemHeader style={{ background: "#168f9d", color: "#d4d4d4" }} title="限制" />
                    ...
                    <div className="performance_item module">
                        ...
                        <Spin spinning={loading} >
                            <div className="description" >
                                <Tooltip title={(<div className="performance-tooltip-content-box"><div className="content-row"><div className="label">起飞正常率:</div> {depRatioSituation}</div><div className="content-row"><div className="label">离港流量:</div> {depFlowSituation}</div></div>)} >
                                    <div className="text-wrapper">
...
export default inject("userSubscribeData", "flightPerformanceData", "implementTacticsData", "systemPage")(observer(FlightPerformance))
