 ...
 * @LastEditTime: 2021-08-18 11:16:48
...
function FlowcontrolDetailCard(props) {
  ...
  const drawSingleFlowcontrolData = (flowcontrolData, index) => {
    const {
      ...
      flowControlTimeInfo = {},
      flowControlMeasure = {},
      TrafficFlowDomainMap = {},
      flowControlPublishType,
      flowControlReason,
      id,
    } = flowcontrolData;
    // 流控开始时间(12位字符串)
    ...
    const { restrictionMode = "", restrictionMITValueUnit = "" } =
      flowControlMeasure;
      ...
      return (
        <div className="ant-row ant-form-item">
          <div className="ant-col ant-form-item-label ant-form-item-label-left">
            <label className="ant-form-item-no-colon" title="最小间隔">
              最小间隔
            </label>
          </div>
          <div className="ant-col ant-form-item-control">
            <div className="ant-form-item-control-input">
              <div className="ant-form-item-control-input-content">
                {isValidVariable(interval)
                  ? `${interval} ${restrictionModeUnit}`
                  : ""}
              </div>
            </div>
          </div>
      ...
      <div className="info-content flowcontrol-list" data-id={id} key={index}>
        <Row className="info-row">
          <Col span={24}>
            <div className="ant-row ant-form-item">
              <div className="ant-col ant-form-item-label ant-form-item-label-left">
                <label className="ant-form-item-no-colon" title="流控名称">
                  流控名称
                </label>
              </div>
              <div className="ant-col ant-form-item-control">
        ...
        <Row className="info-row">
          <Col span={8}>
            <div className="ant-row ant-form-item">
              <div className="ant-col ant-form-item-label ant-form-item-label-left">
                <label className="ant-form-item-no-colon" title="开始时间">
                  开始时间
                </label>
              </div>
              <div className="ant-col ant-form-item-control">
                <div className="ant-form-item-control-input">
                  <div className="ant-form-item-control-input-content">
                    {formatTimeString(flowControlStartTime)}
                  </div>
                </div>
              </div>
            </div>
          ...
          <Col span={8}>
            <div className="ant-row ant-form-item">
              <div className="ant-col ant-form-item-label ant-form-item-label-left">
                <label className="ant-form-item-no-colon" title="结束时间">
                  结束时间
                </label>
              </div>
              <div className="ant-col ant-form-item-control">
                <div className="ant-form-item-control-input">
                  <div className="ant-form-item-control-input-content">
                    {formatTimeString(flowControlEndTime)}
                  </div>
                </div>
              </div>
            </div>
          ...
          <Col span={8}>
            <div className="ant-row ant-form-item">
              <div className="ant-col ant-form-item-label ant-form-item-label-left">
                <label className="ant-form-item-no-colon" title="限制方式">
                  限制方式
                </label>
              </div>
              <div className="ant-col ant-form-item-control">
        ...
        <Row className="info-row">
          <Col span={8}>
            <div className="ant-row ant-form-item">
              <div className="ant-col ant-form-item-label ant-form-item-label-left">
                <label className="ant-form-item-no-colon" title="限制值">
                  限制值
                </label>
              </div>
              <div className="ant-col ant-form-item-control">
                <div className="ant-form-item-control-input">
                  <div className="ant-form-item-control-input-content">
                    {isValidVariable(restrictionModeValue)
