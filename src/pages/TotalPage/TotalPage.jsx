...
function TodoPage(props) {
  ...
  const requestUserSubscribeData = () => {
    ...
    if (isValidVariable(userName)) {
      const opt = {
        url:
          ReqUrls.userSubscribeCapacityFlowMonitorUnitDataUrl +
          userName +
          "/capacityFlowMonitorUnitData",
        method: "GET",
        params: {},
        resFunc: (data) => {
        ...
        <div className="top layout-column">
          <Row className="flex-row">
            <Col className="left-container">
              ...
              >
                <div className="map-container">
                  ...
                  {focus === "NW" ? (
                    <LoadingIframe focus={focus}></LoadingIframe>
                  ) : (
                    ""
                  )}
                  {focus === "ZLXYACC" ? (
            ...
            <Col className="right-container">
              <ModalBox
                title={`航班执行情况 (数据时间:${formatTimeString(
                  props.flightPerformanceData.performanceData.generateTime
                )})`}
                showDecorator={true}
              >
                <Suspense
