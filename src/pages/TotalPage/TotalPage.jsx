...
import { Layout, Spin, Row, Col, Avatar, Radio, message, Button, Tabs } from 'antd'
...
function TotalPage(props) {
    ...
    const initialPanes = [
        { title: '总体监控', content: <PrimaryPane setActiveTabPane={setActiveTabPane}></PrimaryPane>, key: 'primary', closable: false },
    ];
...
export default inject("userSubscribeData", "flightPerformanceData", "systemPage")(observer(TotalPage))
