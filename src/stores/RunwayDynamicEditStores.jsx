...
class RunwayDynamicEditForm {
    ...
    // 更新获取数据时的请求参数
    @action updateRequestParams (params) {
    ...
    @action updateConfigData(data) {
        ...
        // 跑道配置数据
        let listRWGapInfo = data.listRWGapInfoDynamic || [];
        // 跑道配置条数
        ...
        // 机场
        const airport = firstRunway.apName || "";
        // 运行模式
        const operationmode = firstRunway.operationmode || "";
        // groupId
        const groupId = firstRunway.groupId || "";
        // 开始时间
        const startTime = firstRunway.startTime || "";
        // 结束时间
        const endTime = firstRunway.endTime || "";
...
let RunwayDynamicEditFormData = new RunwayDynamicEditForm();

export { RunwayDynamicEditFormData }