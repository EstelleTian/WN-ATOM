...
// 动态跑道发布表单数据
class RunwayFormworkmanagement {
    constructor() {
        makeObservable(this)
    }
    //模态框是否显示
    ...
    @action toModifyVisible(visible){
        this.ModifyVisible = visible;
    }
    @action toAddVisible(visible){
    ...
    //更新当前数据groupId
    @action toGroupId( str ){
        this.isGroupId = str;
    }
    //更新当前数据机场
    @action toAirport( str ){
        this.airport = str;
    }
    //更新当前模板名称
    @action toTemplateName( str ){
...
let RunwayFormworkmanagementData = new RunwayFormworkmanagement();

export { RunwayFormworkmanagementData }