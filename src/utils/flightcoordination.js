...
const FlightCoordination = {
    ...
    CoordinationType : {
        "EXEMPT": "标记豁免",
        "UNEXEMPT": "取消豁免",
        "SINGLEEXEMPT":"标记单流控豁免",
        "UNSINGLEEXEMPT":"取消单流控豁免",
        "INTERVAL":"标记半数间隔",
        "UNINTERVAL":"取消半数间隔",
        "INPOOL":"入等待池",
        "OUTPOOL":"出等待池",
        ...
        "MARK_CLEARANCE": "标记放行",
        "EXCHANGE_SLOT": "时隙交换",
        "MARK_NEED_SLOT": "标记是否需要时隙分配",
        "POINT_TIME": "调整过点时间",
        "FORMER_ID": "人工指定前段航班ID",
        "FME_TODAY": "航班计划管理",
        "MARK_READY": "标记准备完毕",
        "REQ_MANUAL_CTOT":"REQ_MANUAL_CTOT",
        "MARK_QUAL_FLIGHT":"标记飞行资质",
        "SLOT_HOBT_PUB":"发布HOBT",
        "SLOT_HOBT_CNL":"取消HOBT",
        "SLOT_CTOT_PUB":"锁定CTOT",
        "SLOT_CTOT_CNL":"取消CTOT",
        "SLOT_INPOOL":"系统入池",
        "SLOT_MANUAL":"人工指定",
        "SLOT_MANUAL_COBT":"人工指定COBT",
        "SLOT_MANUAL_CTOT":"人工指定CTOT",
        "SLOT_MANUAL_CTO":"人工指定CTO",
        "SLOT_MANUAL_DEP_CTO":"人工指定DEP_CTO",
